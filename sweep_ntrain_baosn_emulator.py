...
The background-family sibling of sweep_ntrain_emulator_cosmic_shear.py:
...
Example:
  python .../sweep_ntrain_baosn_emulator.py \\
    --root projects/baosn/ \\
...
def main():
  ...
  parser = argparse.ArgumentParser(prog="sweep_ntrain_baosn_emulator")
