...
which ai/gates/run_board.py reconciles against the fourteen legs the board
...
#
# An acceptance leg is one named claim the gate makes. ai/gates/board.py declares
# the same fourteen leg ids below in this gate's evidence= tuple, and
# ai/gates/run_board.py reconciles that declaration against the "##AID" lines this
