# Vendored from the symbolic_pofk bundle shipped with the legacy
# emulmps code (Deaglan Bartlett et al., MIT license -- see
# syren/LICENSE; https://github.com/DeaglanBartlett/symbolic_pofk;
# arXiv:2311.15865 linear, arXiv:2402.17492 syren-halofit,
# arXiv:2410.14623 w0wa extension). Function bodies are byte-verbatim;
# the only deviations are import lines, listed in syren/README.md.
import numpy as np
