...
This repository is co-developed by a loop of three AI sessions, one that
designs and audits each change, one that builds it, and one from a different
vendor whose only job is to attack the result. Prof. Miranda directs the
