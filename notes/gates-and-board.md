...
| NEXT | re-run after pull | cmb-smoke with the whitelisted names + whatever bsn/mps showed; full green = GEO's acceptance + the baseline for D-CM12; then the user's full regression pass via `--force-rerun-all` |
