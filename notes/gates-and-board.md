...
| NEXT | the full regression pass | `python gates/run_board.py --force-rerun-all` — BOTH the no-regression proof over the cosmic-shear era AND the FIRST execution of the legs added after their gates' last green: the D-CM13 head legs in cmb/mps-identity (17:56 greens predate them), the D-MP9 identity legs, the two-phase phase-discipline legs (07-12), and the NPCE check_npce legs in all four family identity gates (07-12). Then: the five artifacts, EMUL2, the D-CM12 audit |
