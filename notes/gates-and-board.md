...
| NEXT | the full regression pass | `python gates/run_board.py --force-rerun-all` — BOTH the no-regression proof over the cosmic-shear era AND the FIRST execution of the legs added after their gates' last green: the D-CM13 head legs in cmb/mps-identity (17:56 greens predate them) and the D-MP9 identity legs. Then: the five artifacts, EMUL2, the D-CM12 audit |
