...
Written 2026-07-12 by user order ("add a file on notes/ based on
...
5. **No internal bookkeeping in documentation** (user ruling,
   ...
   on notes/ but not on documentation"). Design-decision codes live
   in notes/ only; documentation states the fact the code stood for
