...
- OPEN unit 41-REPAIR, WITNESS DELTA ONLY: production substance audited PASS and committed on the branch 2026-07-14 (gates-and-board.md, "Unit 41-REPAIR audit"); what remains is the one required witness delta — check_amp_artifact must assert amp_dtype/scaler_policy membership in the extracted resolved_train keys and stop injecting them into its fixture (the audit's deletion probe proved the current arm passes a reverted production). Delta dispatched to Sol.
