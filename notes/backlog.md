...
- OPEN TEX-PROSE-04/05/06: republish the branch at the exact tip + the held audit it unblocks — red-team register adjudication 2026-07-14
...
- OPEN texnotes routing (red-team-owed): emulator_code_guide.tex:5399 prediction-trace Step 1 should gain the (names, values) pair form + the bare-row refusal — named per USER RULE 2026-07-13; notes/gates-and-board.md landings-2+3 audit 2026-07-14
