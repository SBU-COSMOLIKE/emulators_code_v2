...
- OPEN unit-13 covariance package (25M-08/11/12 + 45M-01): implemented on `codex/unit-13-covariance` at 2fd8a9d — FETCHED by the user 2026-07-14 (ref verified); audit trigger already queued as 0150-to-fable — notes/families-scalar-cmb.md implementation readback
