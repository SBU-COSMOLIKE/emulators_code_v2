...
The matter-power-spectrum sibling of sweep_ntrain_emulator_cosmic_shear.py:
...
Example:
  python .../sweep_ntrain_mps_emulator.py \\
    --root projects/mps/ \\
...
def main():
  ...
  parser = argparse.ArgumentParser(prog="sweep_ntrain_mps_emulator")
