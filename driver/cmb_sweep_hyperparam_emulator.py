#!/usr/bin/env python3
"""Sweep ONE YAML-chosen hyperparameter for a CMB-spectrum emulator.

The cmb sibling of cosmic_shear_sweep_hyperparam_emulator.py, and a
...
# The wrapper only pins the family: family="cmb" makes a YAML
# without a data.cmb block fail at startup NAMING the right driver
...
if __name__ == "__main__":
  main(prog="cmb_sweep_hyperparam_emulator", family="cmb",
