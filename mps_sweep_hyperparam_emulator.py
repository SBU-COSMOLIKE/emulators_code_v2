#!/usr/bin/env python3
"""Sweep ONE YAML-chosen hyperparameter for a matter-power emulator.

The mps sibling of cosmic_shear_sweep_hyperparam_emulator.py, and a
...
# The wrapper only pins the family: family="grid2d" makes a YAML
# without a data.grid2d block fail at startup NAMING the right driver
...
if __name__ == "__main__":
  main(prog="mps_sweep_hyperparam_emulator", family="grid2d",
